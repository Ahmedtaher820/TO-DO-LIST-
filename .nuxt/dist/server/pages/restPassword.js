...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/auth/confirm-email.vue?vue&type=template&id=2a4a4a53&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c;
  ...
  return !_vm.emailIsTrue ? _c('div', {
    staticClass: "rest-box shadow mx-auto rounded-4 d-flex flex-column justify-content-center align-items-center"
  }, [_vm._ssrNode("<h3 class=\"fs-3 fw-bold\">Forget Password</h3> <p class=\"text-center text-secondary\">\n    Retrieve your account by writing the email and then verifying with the\n    Gmail through the code sent\n  </p> <input type=\"text\" placeholder=\"Your Email Address\"" + _vm._ssrAttr("value", _vm.email) + "> <div class=\"err text-danger\">" + _vm._ssrEscape(_vm._s(_vm.forgetError)) + "</div> <button type=\"button\">Rest my Password</button>")]) : _vm._e();
};

var staticRenderFns = [];

// CONCATENATED MODULE: ./components/auth/confirm-email.vue?vue&type=template&id=2a4a4a53&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/restPassword.vue?vue&type=template&id=1b367f09&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c;
  ...
  }, [_vm._ssrNode("<h2 class=\"fs-1 fw-bold text-center pt-5 text-light mb-5\">\n    Rest Password Form\n  </h2> "), _c('confirm-email'), _vm._ssrNode(" "), _c('confirm-account')], 2);
};

var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/restPassword.vue?vue&type=template&id=1b367f09&
